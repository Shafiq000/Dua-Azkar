...
//   // some Method
// const ages = [15,20,25];
// const checkAges = ages.some((ages) =>
//    ages == 18
// );
// console.log("Some Method:",checkAges)
// // Map method

// const arr = [{id:1,firstname:"John",}]
// const addArr = arr.map((item)=>{
//  return ({...item, LastName:"Doe"}) 

// })
// console.log("Map Method:",JSON.stringify(addArr,null,2))
// // Filter Method
// const Books =[{
//   title:"Book one",
//   genere:"Friction",
...
// }
// ];
// let checksBooks = Books.filter((bk)=>{
//   return  bk.title === "Book one";

// })
// console.log("Filter:", checksBooks);
  return (
    <SafeAreaView
    style={[
      styles.container,
